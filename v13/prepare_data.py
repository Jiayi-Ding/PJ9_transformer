...
本模块负责下载诗歌数据、中文规范化、体裁分类、主题分类、
无效诗过滤、词表构建、训练/验证集划分与主题标签保存。
"""
